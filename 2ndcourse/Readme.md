...
![none](https://github.com/morningstar0let/-morningstar0let.github.io/blob/master/2ndcourse/101.png)
...
Пользователи в среднем тратят 7 часов в день за компьютером. Предположим, в день в среднем  на ручной ввод информации уходит 15% от этого времени.
В данном случае время, которое затрачивается на ввод - 61 минута. В неделю время составляет 7 часов 7 минут.
При использовании системы распознавания речи, процент временных затрат на ввод снизится до 5%. Следовательно время на ввод составит 2ч22мин/нед.
Потенциальный эффект экономии времени составит 4ч 45мин/нед.

**10.4 Определение числовых показателей и расчет трудозатрат на разработку программных средств:**

Расчет сложности разработки методом FPA IFPUG:

![none](https://github.com/morningstar0let/-morningstar0let.github.io/blob/master/2ndcourse/FPA%20IFPUG.png)

Расчет трудозатрат на разработку «с нуля» методом COCOMO II:

![none](https://github.com/morningstar0let/-morningstar0let.github.io/blob/master/2ndcourse/COCOMOII.png)


**10.5 Сравнительный план-факт:**

![none](https://github.com/morningstar0let/-morningstar0let.github.io/blob/master/2ndcourse/factplan.png)

**Из расчета:**

SLOC = 2 002 строк кода, всего

PM (Трудозатраты) = 9,5 человеко-месяцы

TDEV (Полный срок разработки, месяцы) = 6,9 месяцев


**Исходя из значений по факту:**

SLOC = 300 строк кода, всего

PM (Трудозатраты) = 480 человеко-часы

TDEV (Полный срок разработки) = 2 месяца

Готовность = 95%

**ВЫВОДЫ**

Исходя из результатов таблицы п.10.5 можно сделать вывод, что за счет использования готовых функций и библиотек удалось сократить строки кода (язык программирования Python) в 6,3 раза. Также, за счет сокращения тестирования, объема документации, и использования CASE, удалось сократить срок разработки с 6,9 месяцев до 2. Срок окупаемости разработки сократился в  3,2 раза. На данный момент работа выполнена на 95%, и на остаток реализации по расчету осталось около 15 часов.
